...
video = cv2.VideoCapture('videos/IMG_1479.MOV')
...
with open('yolo-full-set/classes.names') as f:
...
network = cv2.dnn.readNetFromDarknet('yolo-full-set/full_set.cfg',
                                     'yolo-full-set/full_set_last.weights')
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter('videos/result-full-set.mp4', fourcc, 30,
